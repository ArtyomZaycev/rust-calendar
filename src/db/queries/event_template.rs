...
pub fn db_load_event_template_by_id(
...
pub fn db_insert_event_template(
    connection: &mut MysqlConnection,
...
pub fn db_update_event_template(
    connection: &mut MysqlConnection,
...
pub fn db_delete_event_template(connection: &mut MysqlConnection, eid: i32) -> Result<(), Error> {
    use crate::db::schema::event_templates::dsl::*;
